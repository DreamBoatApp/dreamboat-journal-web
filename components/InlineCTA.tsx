        ...
        <section className="my-12 relative overflow-hidden rounded-2xl border border-indigo-500/20">
            ...
            <div className="relative z-10 p-8 md:p-10 flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    {/* Coming Soon */}
                    <span className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 border border-white/20 rounded-full text-white/60 font-semibold text-sm cursor-default">
