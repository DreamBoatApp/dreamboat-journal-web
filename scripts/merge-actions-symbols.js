...
newSymbols.forEach(symbol => {
    // Basic normalization for key (e.g. "Arguing" -> "ARGUING")
    ...
    const entry = `    "${key}": { meaning: "ACTION/SITUATION", associations: [] },`;
...
if (addedCount > 0) {
    ...
    if (lastBraceIndex !== -1) {
        ...
        console.log(`Successfully added ${addedCount} new action symbols to dictionary.`);
    } else {
